...
enum PLAYER_STATE { IDLE, WALK, RUN, JUMP, FALL, }  # Будут добавлены позже: IN_DIALOGUE, TAKE_DAMAGE, DEATH, OBSERVING, PANIC
#endregion
...
const PATH_PLAYER_DATA: StringName = &"res://data/player/player_data.tres"
#endregion
